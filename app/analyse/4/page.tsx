...
const question = {
  id: 4,
  text: "Do you currently have a skincare routine?",
  options: [
    "No routine (just water/soap)",
    "Basic (cleanser only)",
    "Simple (cleanser + moisturizer)",
    "Moderate (3–4 products)",
    "Advanced (5+ products, active ingredients)",
  ],
};
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-10">
          <div className="h-[4px] w-full bg-[#e5ddd4] rounded-full overflow-hidden">
            <div className="h-full w-[56%] bg-[#bf908a]" />
          </div>
